...
void MainWindow::keyPressEvent(QKeyEvent * event)
{
    ...
    if(event->key() == Qt::Key_Q){
        ui->GameQbutton->pressed();

    }
    if(event->key() == Qt::Key_P){
        ui->GamePbutton->pressed();
...
{
    if(event->key() == Qt::Key_Q){
        ui->GameQbutton->released();

    }
    if(event->key() == Qt::Key_P){
        ui->GamePbutton->released();
    }

}

void MainWindow::on_GameQbutton_pressed()
{
    ui->mid->show();
    QTime t;
...
void MainWindow::on_GameQbutton_released()
{
    ui->mid->hide();
}

void MainWindow::on_GamePbutton_pressed()
{
    ui->around->show();
    QTime t;
...
void MainWindow::on_GamePbutton_released()
{
    ui->around->hide();
}
